...
class ThisB{
	...
	ThisB(int n){ //생성자1
		num1=n;
		System.out.println("ThisB 클래스의 생성자1이 호출");//1
	}
 ThisB(int n1, int n2){ 
	 //num1 =n1;
	 this(n1);//this라는 이름으로 자신의 형제 생성자를 호출 //1
	 num2=n2;
	 System.out.println("ThisB 클래스의 생성자2이 호출"); //2
  }
 ThisB(int n1, int n2, int n3){	 
	 //this를  사용한 생성자간 호출코드는 반드시 생성자의 명령중 첫번째 실행코드로만 사용가능
	 this(n1,n2); //1,2
	 this.num1=n3;
	 System.out.println("ThisB 클래스의 생성자3이 호출");//3
}
}
